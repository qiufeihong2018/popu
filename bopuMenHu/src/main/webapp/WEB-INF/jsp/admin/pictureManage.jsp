									...
									<div class="file">
										<a
											...
											<div class="file-name">
												...
												<a
													href="${pageContext.request.contextPath}/admin/uploadPicture?sort=${content.sort}&category=2">替换图片</a>
												<a
													onclick="$('#myModal').modal('show');getList(${content.id})">修改文章</a>
												<br />
											</div>
										</a>
									</div>
									...
									<div class="file">
										<a
											...
											<div class="file-name">
												...
												<a
													href="${pageContext.request.contextPath}/admin/uploadPicture?sort=${content.sort}&category=1">替换图片</a>
												<a
													onclick="$('#myModal').modal('show');getList(${content.id})">修改文章</a>
												<br />
											</div>
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default"
						onclick="prePage(this)">上一页</button>
					<button type="button" class="btn btn-primary"
						onclick="nextPage(this)">下一页</button>
