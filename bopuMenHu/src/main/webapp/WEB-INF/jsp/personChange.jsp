...
<main class="content">
    <div id="biaodan">
        <form action="${pageContext.request.contextPath}/user/personChange" class="form1" method="post" name="form1" target="_blank" id="form1">
            <br> <br> <br>
            <h1>个人中心</h1>

            <!--账号-->
            <input type="hidden" name="id" value="${user.id}">
            <input id="account" readonly="readonly" value="${user.account}"   type="text" class="form-control" placeholder="账号" onfocus="showTips('account','账号必填!')" onblur="check('account','账号不能为空！')">
            <br>
            <span id="accountspan" style="margin-left: -200px;"></span>
            <br>
            <!--姓名-->
            <input id="name" readonly="readonly" value="${user.name}"  type="text" class="form-control" placeholder="姓名" onfocus="showTips('name','姓名必填!')" onblur="check('name','姓名不能为空！')">
            <br>
            <span id="namespan" style="margin-left: -200px;"></span>
            <br>
            <!--手机号-->
            ...
            <br>
            <span id="phonespan" style="margin-left: -200px;"></span>
            <br>
            <!--通讯地址-->
            <input name="address" value="${user.address}" type="text" class="form-control" placeholder="通讯地址">
            <br> <br>

            <!--工作单位-->

            <input id="work" value="${user.work}" name="work" type="text"  class="form-control" placeholder="工作单位 "onfocus="showTips( 'work', '工作单位必填!') " onblur="check( 'work', '工作单位不能为空！') ">
            <br>
            <span id="workspan"  style="margin-left: -170px; "></span>
            <br>
            <!--职称-->
            <input name="professional " value="${user.professional}" type="text "   class="form-control " placeholder="职称 ">
            <br><br>
            <!--职务-->
            <input name="duties" value="${user.duties}" type="text" class="form-control" placeholder="职务" />
            <br> <br>
            <!--岗位-->
            <input name="station" value="${user.station}" type="text" class="form-control" placeholder="岗位">
            <br> <br>
            <!--邮箱-->

            <input id="Email" name="email" value="${user.email}" type="text" class="form-control" placeholder="邮箱" onfocus="showTips( 'Email', '邮箱必填!') " onblur="check( 'Email', '邮箱不能为空！') ">
            <br>
